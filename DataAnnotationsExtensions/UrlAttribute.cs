...
namespace DataAnnotationsExtensions
{
    ...
    public class UrlAttribute : DataTypeAttribute
    {
        ...
        private readonly bool _excludeProtocol = false; //Default to not exclude protocol
        ...
        public UrlAttribute(bool requireProtocol = true, bool excludeProtocol = false)
            : base(DataType.Url)
        {
            _requireProtocol = requireProtocol;
            _excludeProtocol = excludeProtocol;
