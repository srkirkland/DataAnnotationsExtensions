...
namespace DataAnnotationsExtensions
{
    ...
    /// <summary>
    /// Validates that the property is greater than or equal to the given 'otherProperty' 
    /// </summary>
    /// <remarks>
    /// From Mvc3 Futures
    /// </remarks>
    [AttributeUsage(AttributeTargets.Property, AllowMultiple = false)]
    public class GreaterThanOrEqualToAttribute : BaseComparisonAttribute
    {
        public GreaterThanOrEqualToAttribute(string otherProperty) : base(otherProperty) { }
        ...
        internal override string GetDefaultError()
        {
            return ValidatorResources.CompareAttribute_MustBeGreaterOrEqualTo;
        }
